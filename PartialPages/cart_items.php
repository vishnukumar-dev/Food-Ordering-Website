            ...
            <section id="cart" class="py-3">
                <div class="container-fluid w-75">
                    <h5 class="font-baloo font-size-20">Your Food Cart</h5>
                    ...
                    <div class="row">
                        <div class="col-sm-9">
                            ...
                            <div class="row border-top py-3 mt-3">
                                ...
                                <div class="col-sm-8">
                                    <h5 class="font-baloo font-size-20">Burger</h5>
                                    <!-- product rating -->
                                    <div class="d-flex">
                            ...
                            <div class="row border-top py-3 mt-3">
                                ...
                                <div class="col-sm-8">
                                    <h5 class="font-baloo font-size-20">Chow mein</h5>
                                    <!-- product rating -->
                                    <div class="d-flex">
                                        <div class="rating text-warning font-size-12">
                                            <span><i class="fas fa-star"></i></span>
                                ...
                                <div class="col-sm-2 text-right">
                                    <div class="font-size-20 text-danger font-baloo">
                                    ₹<span class="product_price">70</span>
                                    </div>
                                </div>
                            </div>
                            <!-- !cart item -->
                        ...
                        <div class="col-sm-3">
                            <div class="sub-total border text-center mt-2">
                                ...
                                <div class="border-top py-4">
                                    <h5 class="font-baloo font-size-20">Subtotal (2 item):&nbsp; <span class="text-danger">₹<span class="text-danger" id="deal-price">170.00</span> </span> </h5>
